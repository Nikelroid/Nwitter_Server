...
import com.java.loadTwittes.loadCfg;
...
public class likes {
    private static final Logger logger = LogManager.getLogger(likes.class);
    ...
    public ArrayList<String> get(String serial) {
        ...
        try {
            ...
            if(twitte==null){
                ...
                List<String> likes = twitte.getList("likes",String.class);
